...
class KerasSequenceModelsTest(tf.test.TestCase):
  ...
  def test_model_initialization_uses_random_seed(self):
    ...
    self.assertAllClose(
        model_1_with_seed_0.weights, model_2_with_seed_0.weights
    )
    self.assertAllClose(
        model_1_with_seed_1.weights, model_2_with_seed_1.weights
    )
    self.assertNotAllClose(
        model_1_with_seed_0.weights, model_1_with_seed_1.weights
    )

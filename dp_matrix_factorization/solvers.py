...
@tf.function
def solve_directly_for_optimal_w(*, constraint_matrix: tf.Tensor,
                                 target_vector: tf.Tensor) -> tf.Tensor:
...
@tf.function
def _construct_e_matrix(row_constraint: tf.Tensor,
                        row_dim: tf.Tensor) -> tf.Tensor:
...
def solve_for_constrained_w_row_with_pseudoinv(
    h_matrix: tf.Tensor, s_row: tf.Tensor,
    row_constraint: tf.Tensor) -> tf.Tensor:
...
def solve_for_constrained_w_with_pseudoinv(
    ...
    w_constraint_matrix: tf.Tensor) -> tf.Tensor:
...
@tf.function
def solve_directly_for_optimal_full_batch_w(h_matrix: tf.Tensor,
                                            s_matrix: tf.Tensor) -> tf.Tensor:

...
def unbias_miracle(k, epsilon, number_candidates, z, n, normalization=1):
  ...
  Args:
    ...
    normalization: Indicator whether to clip and normalize or project on the
      simplex
  ...
  expectation = np.sum(
      stats.binom.pmf(range(number_candidates + 1), number_candidates, d / k) *
